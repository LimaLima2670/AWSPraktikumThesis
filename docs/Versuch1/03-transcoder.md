...
![MediaConvert Region](../assets/mediaconvert_region.png)
...
![AWS Elemental MediaConvert Warteschlangen](../assets/mediaconvert_queue.png)
...
![MediaConvert Neuer Auftrag](../assets/mediaconvert_new_job.png)
...
![MediaConvert CPL](../assets/mediaconvert_cpl.png)
...
![MediaConvert File Group](../assets/mediaconvert_output.png)
...
![MediaConvert Videosettings](../assets/mediaconvert_video.png)
...
![MediaConvert Timecode](../assets/mediaconvert_timecode.png)
...
![MediaConvert Audiosettings](../assets/mediaconvert_audio.png)
...
![MediaConvert Rolle](../assets/mediaconvert_role.png)
...
![MediaConvert Warteschlange](../assets/mediaconvert_job_queue.png)
...
<div style="border:2px solid #06b6d4; background:#0f172a; padding:18px; border-radius:8px; margin:25px 0;">
...
![MediaConvert Job Progressing](../assets/mediaconvert_job_progressing.png)

Ist der Auftrag erledigt, wird der Status `COMPLETE` angezeigt.

![MediaConvert Job Completed](../assets/mediaconvert_job_complete.png)
