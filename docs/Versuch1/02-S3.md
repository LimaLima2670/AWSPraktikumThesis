...
Welche Redundanzen und welche Zuverlässigkeit bietet <strong>S3-Objektspeicher</strong> laut Amazon?<br><br>

Was ist der Unterschied zwischen der <strong>Verfügbarkeit des S3-Services</strong> und der <strong>Verfügbarkeit eines einzelnen Objektes über ein Jahr</strong>?
...
![S3 Dashboard](../assets/s3_dashboard.png)
...
![S3 Bucket Erstellung](../assets/s3_erstellung.png)
...
![S3 Quelldateien](../assets/s3_sourcefiles.png)
...
➡️ **Nächstes Kapitel:**  
[Transcodierung mit MediaConvert](03-transcoder.md)
