...
![Lambda Funktion erstellen](../assets/lambda_createFunction.png)

**Sind die Infos eingetragen, kann auf "Funktion erstellen" geklickt werden, um die Funktion zu erstellen.**

![Lambda Funktion erstellt](../assets/lambda_createFunctionSuccess.png)
...
![Lambda Funktion Auslöser](../assets/lambda_ausloeser.png)
...
![Lambda Funktion Auslöser Bucket](../assets/lambda_ausloeser_bucket.png)

Ist der Auslöser erstellt, wird er oben in der Übersicht angezeigt.

![Lambda Funktion Auslöser Bucket](../assets/lambda_ausloeser_bucket_success.png)
...
![Lambda Funktion Code](../assets/lambda_code.png)
...
![Lambda Funktion Timeout](../assets/lambda_timeout.png)
